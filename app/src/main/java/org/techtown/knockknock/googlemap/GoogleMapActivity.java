package org.techtown.knockknock.googlemap;
...
public class GoogleMapActivity extends AppCompatActivity implements AutoPermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.gm_button1);
        button2 = findViewById(R.id.btn_locationchange_myloc);
        textView1 = findViewById(R.id.gm_textView1);
    ...
    public void startLocationService() {
        try {
            ...
            long minTime = 1000;        // 0초마다 갱신 - 바로바로갱신
            float minDistance = 0;
